...
const PRODUCTS_DETAIL = {
  "fotospiegel-glow": {
    ...
    longDescription: "Mit seinem eleganten goldenen Rahmen und der interaktiven LED-Beleuchtung ist der GLOW nicht nur ein Fotospiegel, sondern ein echtes Statement-Piece. Die Sofortdrucke ermöglichen es deinen Gästen, ihre Fotos direkt mitzunehmen – perfekt für Gästebücher oder als Andenken.",
    specs: [
      { label: "Größe", value: "ca. 120 x 80 cm" },
      { label: "Rahmen", value: "Hochwertiges Metall, Gold-Finish" },
      { label: "Beleuchtung", value: "LED-Ring, warmweiß" },
      { label: "Drucke", value: "Sofortdruck (10x15 cm), bis zu 100 Stück pro Event" },
    ...
    pricing: [
      { label: "Mietgebühr (4h)", value: "299,- €" },
      { label: "Jede weitere Stunde", value: "+50,- €" },
      { label: "Lieferung & Aufbau", value: "kostenlos" },
      { label: "Drucke (pro Stück)", value: "0,50 €" },
    ],
    faq: [
      {
        q: "Wie viele Fotos können gemacht werden?",
        a: "Unbegrenzt! Es gibt keine Obergrenze. Die Drucke kosten 0,50 € pro Stück.",
      },
      {
      ...
      },
      {
        ...
        a: "Ja, wir kümmern uns um Aufbau, Betreuung und Abbau. Du brauchst dich um nichts zu kümmern.",
      },
      {
        q: "Kann man den Rahmen individualisieren?",
        a: "Ja! Wir können den Rahmen mit deinem Namen, Logo oder Motiv bedrucken lassen.",
      },
    ],
  },
  "audio-gstebuch-vivi": {
    ...
    specs: [
      ...
      { label: "Betrieb", value: "Batteriebetrieb oder Stromanschluss" },
      { label: "Format", value: "MP3 / WAV" },
      { label: "Aufbau", value: "ca. 10 Minuten" },
    ],
    features: [
    ...
    faq: [
      ...
      {
        q: "In welchem Format erhalte ich die Aufnahmen?",
        a: "Als MP3 oder WAV-Datei. Du kannst sie direkt anhören oder nachbearbeiten.",
      },
      {
  ...
  "polaroidkamera-dior": {
    ...
    longDescription: "Die Polaroidkamera DIOR bringt nostalgischen Charme auf dein Event. Mit echten Sofortbildern (kein Druck!) haben deine Gäste ein echtes, analoges Andenken – perfekt zum Signieren im Gästebuch oder zum Aufhängen an eine Fotowand.",
    specs: [
      { label: "Filmformat", value: "Instax Wide (86 x 108 mm)" },
      { label: "Objektiv", value: "Festfokus, Blitz" },
      { label: "Batterie", value: "AA-Batterien" },
      { label: "Film", value: "Instax Wide Film (10er Pack)" },
      { label: "Anzahl Kameras", value: "2-3 Kameras im Set" },
    ],
    features: [
      "Echte Sofortbilder",
      "Einfache Bedienung",
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "Januar 2026",
        text: "Die Polaroid-Kameras waren ein voller Hit! Alle Gäste wollten Fotos machen und die Bilder im Gästebuch signieren.",
        event: "Hochzeit",
      },
    ],
    pricing: [
      { label: "Mietgebühr (4h)", value: "29,- €" },
      { label: "Jede weitere Stunde", value: "+5,- €" },
      { label: "Lieferung & Aufbau", value: "kostenlos" },
      { label: "Film (10er Pack)", value: "+8,- €" },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        a: "Ja, die Polaroid-Bilder haben einen weißen Rand – perfekt zum Signieren!",
      },
    ],
  },
  "slushmaschine-emit": {
    ...
    specs: [
      { label: "Kapazität", value: "ca. 20 Liter pro Stunde" },
      { label: "Größe", value: "ca. 80 x 50 x 100 cm" },
      { label: "Gewicht", value: "ca. 30 kg" },
      { label: "Betrieb", value: "Stromanschluss erforderlich" },
      { label: "Geschmacksrichtungen", value: "Erdbeere, Himbeere, Zitrone, Blaubeere" },
      { label: "Aufbau", value: "ca. 20 Minuten" },
    ],
    features: [
      "Hochleistungsmotor",
    ...
    pricing: [
      { label: "Mietgebühr (4h)", value: "149,- €" },
      { label: "Jede weitere Stunde", value: "+30,- €" },
      { label: "Lieferung & Aufbau", value: "kostenlos" },
      { label: "Sirupe (pro Geschmack)", value: "+15,- €" },
      { label: "Alkohol-Upgrade", value: "+20,- €" },
    ],
    faq: [
      {
        q: "Wie viele Gäste können bedient werden?",
        a: "Mit ca. 20 Litern pro Stunde können 50-100 Gäste gut versorgt werden. Bei größeren Events empfehlen wir 2 Maschinen.",
      },
      {
        q: "Ist das Alkohol-Upgrade möglich?",
        a: "Ja! Wir können die Slushmaschine mit Rum, Vodka oder anderen Spirituosen bestücken. Gerne beraten wir dich!",
      },
      {
        q: "Welche Geschmacksrichtungen gibt es?",
        a: "Erdbeere, Himbeere, Zitrone, Blaubeere. Gerne können wir auch andere Geschmäcker arrangieren.",
      },
    ],
  },
  "karaokemaschine-sing": {
    ...
    specs: [
      ...
      { label: "Lautsprecher", value: "2x 100W Stereo-Lautsprecher" },
      { label: "Mikrofone", value: "2x kabellose Mikrofone" },
      { label: "Display", value: "7\" Touchscreen" },
      { label: "LED-Effekte", value: "RGB-Beleuchtung" },
      { label: "Betrieb", value: "Stromanschluss erforderlich" },
    ],
    features: [
    ...
    pricing: [
      { label: "Mietgebühr (4h)", value: "69,- €" },
      { label: "Jede weitere Stunde", value: "+15,- €" },
      { label: "Lieferung & Aufbau", value: "kostenlos" },
      { label: "Techniker vor Ort", value: "kostenlos" },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        a: "Ja, wir können deine Lieblingssongs vor dem Event hinzufügen!",
      },
      {
        q: "Wie viele Mikrofone gibt es?",
        a: "2 kabellose Mikrofone sind im Standard-Set enthalten. Weitere Mikrofone können hinzugefügt werden.",
      },
    ],
  },
  "zuckerwattemaschine-luna": {
    ...
    specs: [
      ...
      { label: "Größe", value: "ca. 70 x 70 x 100 cm" },
    ...
    pricing: [
      ...
      { label: "Jede weitere Stunde", value: "+10,- €" },
      { label: "Lieferung & Aufbau", value: "kostenlos" },
      { label: "Zucker & Sticks", value: "inklusive" },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        a: "Rosa, Blau, Grün, Gelb und Weiß. Gerne können wir auch andere Farben arrangieren!",
      },
      {
        q: "Ist Zucker inklusive?",
        a: "Ja, Zucker und Sticks sind im Mietpreis enthalten.",
      },
    ],
  },
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="bg-[oklch(0.32_0.07_155)] text-white rounded-xl p-6 mb-6">
                ...
                <p className="text-sm text-white/80">Lieferung & Aufbau kostenlos</p>
              </div>
